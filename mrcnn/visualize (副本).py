...
def frag_percentage_count(image, image_name, boxes, masks, class_ids, scores, class_names, filter_classs_names=None,
    ...
    radius = min(masked_image.shape[0],masked_image.shape[1])/2
